      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="group relative p-8 lg:p-10 bg-gradient-to-br from-silver/[0.03] to-silver/[0.01] backdrop-blur-sm rounded-2xl border border-silver/[0.08] hover:border-silver/[0.15] transition-all duration-500 hover:bg-silver/[0.05]"
            >
              {/* Hover Glow Effect */}
